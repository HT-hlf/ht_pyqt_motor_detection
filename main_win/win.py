...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon.addPixmap(QtGui.QPixmap("./icon/cqu_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
# "border-radius:5px;}")
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(./icon/background5.jpeg);\n"
                                       "border: 0px solid #42adff;\n"
                                       "border-radius:5px;}")
...
# "border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(./icon/cqu_icon.png);")
...
#         self.raw_video.setStyleSheet("color: rgb(41, 36, 33);\n"
# "")
...
#         self.raw_video.setObjectName("raw_video")
        ...
        self.out_video.setStyleSheet("color: rgb(41, 36, 33);\n"
"")
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "电机外表面检测界面 v1.0"))
        self.label_4.setText(_translate("mainWindow", "  电机外表面检测界面 v1.0"))
        ...
        self.label_6.setText(_translate("mainWindow", "检测显示区"))
